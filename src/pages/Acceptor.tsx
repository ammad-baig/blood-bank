    ...
    return (
        <>
            <div className='d-flex justify-content-around align-items-center'>
                <ABButton onClick={navToAcceptor} label='Giving Blood' />
                <h1 className='text-center m-4 fw-bold'>Blood Donate Center</h1>
                        ...
                        <div className='col-md-12'>
                            ...
                            <div className='d-flex justify-content-center align-items-center '>
                                {users.map((x: any, i: any) => {
                                    return (
                                        <>
                                            <div className='boder border-1 border-black m-4 p-5'>
                                                <p>
                                                    Name : {x.fullName}
                                                </p>
                                                <p>
